...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String guessA = JOptionPane.showInputDialog("who is this?");

		// 5. Check their answer. If they guessed correctly:
		if (guessA.equalsIgnoreCase("Arnold")) {
		...
		showNextImage();
		String guessB = JOptionPane.showInputDialog("who is this?");
		if (guessB.equalsIgnoreCase("Leonardo")) {
			JOptionPane.showMessageDialog(null, "You are correct");
			score++;
		...
		showNextImage();
		String guessC = JOptionPane.showInputDialog("who is this?");
		if (guessC.equalsIgnoreCase("Morgan")) {
			JOptionPane.showMessageDialog(null, "You are correct");
			score++;
		...
		showNextImage();
		String guessD = JOptionPane.showInputDialog("who is this?");
		if (guessD.equalsIgnoreCase("Black")||guessD.equalsIgnoreCase("jack")) {
			JOptionPane.showMessageDialog(null, "You are correct");
			score++;

		} else {
			JOptionPane.showMessageDialog(null, "Incorrect, it is 'Jack' or ' Black'");
		}
		showNextImage();
